...
<body style="background-color: hsl(0, 0%, 97%);" onload="window.onload = resizeAllGridItems(); window.addEventListener('resize', resizeAllGridItems);">
	...
	<div class="userinfo" style="background-color: white;padding-bottom: 100px;">
		<div style="padding-top: 100px;padding-bottom: 20px;">
			<ul style="float: left;width: 2000px;">
				<li style="display: inline;padding: 10px;"><a href="editprofile.php" style="text-decoration: none;"><i class="fas fa-user-edit" style="font-size: 30px;color: grey;"></i></a></li>
				<li style="display: inline;padding: 10px;"><a href="uploadfrompc.php"  style="text-decoration: none;"><i class="fas fa-plus" style="font-size: 30px;color: grey;"></i></a></li>
				<li style="display: inline;padding: 10px;"><a href="uploadfromweb.php" style="text-decoration: none;"><i class="fas fa-upload" style="font-size: 30px;color: grey;"></i></a></li>
			</ul>
		</div>
		<div><h1 style="font-family: Courier new;padding-top: 70px;padding-left: 10px;"><?php echo $n; ?></h1></div>
		<div><p style="font-family: Courier new;padding-top: 5px;padding-left: 10px;margin-bottom: 50px;"><strong><?php echo $counter." photos"; ?></strong></p></div>
