...
<?php
    ...
    // Assuming the db query returned an object, adapt for array otherwhise
		...
		else
		{
			...
			$html .= "<div class='item' style='width:300px;background-color: hsl(0, 0%, 97%);' id='item'><div class='content' style='background-color: hsl(0, 0%, 97%);'><form action='home.php' method='post'><button name='liked".$counter."' ><div ".$bb." id='like' onclick='selected(this)' class='likebtn' name='likebtn" .$counter."'
			 ><i class='fas fa-heart' style=''></i></div></button><button type='submit' style='border:0px solid white;text-decoration:none;' name = 'clickphoto".$counter."'><div style='width:300px;border-radius:20px;'><img src='uploads/".$row['image']."'  class='photo' ><div><h3 class='heading'>".$row['Title']."</h3><p class='details'>".$row['text']."</p></div></div></button></form></div></div>";
		$counter++;
	}
	...
	<div style="position: sticky;top:0px;background-color: white;padding-bottom: 70px;box-shadow: 6px 6px 5px grey;">
		<nav class="navbar" style="background-color: white;">
			<ul class="navlist" style="background-color: white;">
				...
				<li class="listitem"><form action="home.php" method="post" style="display: inline;" ><input type="text" name="search" placeholder="Search" class="searchbar" style="width: 960px;">  </li>
